...
void sendADC(void) {
    ...
    /*
     Salida del ADC:
        parteA = 12345678, parteB = 9AXXXXXX
        aux = 12345678 & 0x07 = 00000678
        aux << 2 = 00067800
     *  parteA >> 3 = 00012345
     *  parteA | 0x80 = 10012345
     *  parteB >> 6 = 0000009A
     *  parteB | aux = 00067800 | 0000009A = 0006789A
     *  parteA = 10012345
     *  parteB = 0006789A
     */
...
void printADC(float value)
{
    ...
    unsigned char j;
    int i;
    float temperature = (value*50)/5 - 0.3; //Suponiendo que 50C = 5V y 0C = 0V
//    float temperature = (value/7.8) * 100; //Con ganancia 7.8
